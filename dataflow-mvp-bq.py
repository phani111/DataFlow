...
def run(argv=None):
    ...
    parser.add_argument('--output_table',required=True,default='mvp-project-273913:michael.account_id_schema_output',help=('Output BigQuery table for results specified as: ''PROJECT:DATASET.TABLE or DATASET.TABLE.'))
